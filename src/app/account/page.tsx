...
type Profile = { user: { id: string; email: string; displayName: string; plan?: Plan; trustedDevices: Array<{ _id: string; name: string; lastSeenAt: string }> }; contacts: Array<{ _id: string; name: string; phone: string; email: string; priority: number }>; trips: unknown[] };
type Registration = { displayName: string; email: string; password: string; plan: Plan; contactName: string; contactPhone: string; contactEmail: string; locationMonitoring: boolean };

const emptyRegistration: Registration = { displayName: "", email: "", password: "", plan: "basic", contactName: "", contactPhone: "", contactEmail: "", locationMonitoring: false };
...
export default function AccountPage() {
  ...
  useEffect(() => {
    const refresh = () => { if (getToken()) void loadProfile(); };
