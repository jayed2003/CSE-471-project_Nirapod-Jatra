...
type Registration = { displayName: string; email: string; password: string; contactName: string; contactPhone: string; locationMonitoring: boolean };

const emptyRegistration: Registration = { displayName: "", email: "", password: "", contactName: "", contactPhone: "", locationMonitoring: false };
