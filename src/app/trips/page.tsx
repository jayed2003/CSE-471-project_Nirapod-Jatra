...
type Trip = { _id: string; destination: string; currentRiskBrief?: string; updatedAt: string; travelDates?: { start?: string; end?: string }; route?: { distanceMeters?: number; durationSeconds?: number }; shadowProfile?: ShadowProfile };
