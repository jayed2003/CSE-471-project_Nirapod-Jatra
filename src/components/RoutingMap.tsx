  ...
  useEffect(() => {
    ...
    async function loadRoute() {
      ...
      try {
        ...
        alternativesRef.current.forEach((_, index) => { const id = `route-line-${index}`; const source = `route-${index}`; if (map.getLayer(id)) map.removeLayer(id); if (map.getSource(source)) map.removeSource(source); });
