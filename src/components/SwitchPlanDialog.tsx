...
const BASIC_FEATURES = [
  ...
  "Route planning & risk brief",
  "Trip-time optimization",
];
const PREMIUM_FEATURES = [
  "Everything in Basic",
  "SOS script generator",
  "Bangla safe-word voice SOS",
  "Share live location",
  "Route readiness & offline low-network packs",
];
...
export function SwitchPlanDialog({
  ...
  return (
    <div className="confirm-overlay" onClick={onClose}>
      <div
        className="confirm-dialog switch-plan-dialog"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="plan-columns">
          <article className={`plan-card ${currentPlan === "basic" ? "current" : ""}`}>
            ...
            {currentPlan === "premium" && (
              <button className="confirm-no" disabled={switching} onClick={() => void switchPlan()}>
                Switch to Basic
              </button>
            )}
          </article>
          <article className={`plan-card ${currentPlan === "premium" ? "current" : ""}`}>
            ...
            {currentPlan === "basic" && (
              <button className="confirm-go" disabled={switching} onClick={() => void switchPlan()}>
                Switch to Premium
              </button>
            )}
          </article>
