...
export function EmergencyServicesPanel({ center, onSelect, selectedId, tripId }: { center: [number, number]; onSelect?: (service: SelectedEmergencyService, id: string) => void; selectedId?: string | null; tripId?: string }) {
