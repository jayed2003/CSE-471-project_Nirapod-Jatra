...
function factsFor(overrides: Partial<SosScriptFacts> = {}): SosScriptFacts {
  ...
  return {
    ...
    address: {
      ...
      area: "Banani",
      city: "Dhaka",
      displayName: "Road 11, Banani, Dhaka, Bangladesh",
    },
    landmark: {
      name: "Banani Bidyaniketan",
      category: "school",
      point: [90.406, 23.7795],
      distanceM: 180,
      bearingBn: "উত্তর-পূর্বে",
      bearingEn: "north-east",
    },
    alternatives: [],
    situation: {
      type: "accident",
...
describe("shortAddress", () => {
  it("joins road, area and city and drops duplicates", () => {
    expect(shortAddress({ road: "Road 11", area: "Banani", city: "Dhaka", displayName: "…" })).toBe(
